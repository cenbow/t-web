...
public class PropertyUtil {
    ...
    private static final String CONFIG_PAYAPI_NAME = "pay/payapi.properties";
    ...
    static {
        ...
        try {
            ...
            config.load(PropertyUtil.class.getClassLoader().getResourceAsStream(CONFIG_PAYAPI_NAME));
