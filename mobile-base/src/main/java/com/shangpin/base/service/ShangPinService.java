...
public interface ShangPinService {
     ...
     * 
     * queryGalleryList:<br/>
     * @param type 1：新品顶部轮播图; 2：商城顶部轮播图; 3:首页轮播图4：品牌轮播
     * @param frames 
     * @param brandId 品牌ID
     * @return
     */
     ...
     * 
     * queryGalleryList:<br/>
     * 2016-06-21正对包含2.9.16以后版本添加 <br/>
     * @param type 1：新品顶部轮播图; 2：商城顶部轮播图; 3:首页轮播图4：品牌轮播
     * @param frames 
     * @param isSizePic 是否显示大图 当isSizePic= 或者0时为小图,为1时返回大图
     * @param brandId 品牌ID
     * @return
     */
     ...
     * @return
     */
    String findOrderMoreLogistic(String json);
}