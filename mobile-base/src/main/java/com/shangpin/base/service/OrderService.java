...
public interface OrderService {
	 ...
	 * @author zhongchao
	 */
	public String findOrderNew(String userId, String orderId);
	 ...
	 * @return
	 */
	 String updatePayType(String json);
	 ...
	 * @return String
	 */
	String payGiftCards(String json);
	 ...
	 * @return
     */
	String orderPriceInfo(String s);
