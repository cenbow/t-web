...
public class CouponsServiceImpl implements CouponsService {
    ...
    //提交订单页选择优惠券列表V3
    private StringBuilder canUseCouponsRULV3 = new StringBuilder(GlobalConstants.BASE_URL_ORDER).append("Settlement/GetTicketList");
    ...
    @Override
    public String canUseCouponsV3(String s) {
        Map<String, String> params = new HashMap<String, String>();
        params.put("jsonMsg", s);
        return HttpClientUtil.doGet(canUseCouponsRULV3.toString(), params);
    }
}
