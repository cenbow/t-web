...
public class SettlementServiceImpl implements SettlementService {
    ...
    private static String settleV3 = new StringBuilder(GlobalConstants.BASE_URL_ORDER).append("settlement/SettlementOrder").toString();

    private static String settleRefreshV3= new StringBuilder(GlobalConstants.BASE_URL_ORDER).append("settlement/settlementOrderRefresh").toString();

    private static String orderSubmitV3= new StringBuilder(GlobalConstants.BASE_URL_ORDER).append("Order/ConfirmOrder").toString();
    /**
     * 购物车结算
     *
     * @param userid
    ...
    @Override
    public String settleV3(String json) {
        Map<String,String> map = new HashMap<>(2);
        map.put("jsonMsg",json);
        String result = HttpClientUtil.doPost(settleV3, map);
        return result;
    }

    @Override
    public String settleRefreshV3(String json) {

        Map<String,String> map = new HashMap<>(2);
        map.put("jsonMsg",json);
        String result = HttpClientUtil.doPost(settleRefreshV3, map);
        return result;
    }

    @Override
    public String submitV3(String json) {

        Map<String,String> map = new HashMap<>(2);
        map.put("jsonMsg",json);
        String result = HttpClientUtil.doPost(orderSubmitV3, map);
        return result;
    }
}
