...
// 礼品卡--根据卡id获取礼品卡状态
	...
	//订单跟踪V3
	private StringBuilder logisticUrl = new StringBuilder(GlobalConstants.BASE_URL_ORDER).append("OrderCenter/GetOrderLogistic");
  /*  *//** 
     * 全部品牌
     * 
     * @return
    ...
    public String queryBrandList() {
        Map<String, String> params = new HashMap<String, String>();
      //  return HttpClientUtil.doGet(brandListURL.toString(), params);
        return  BaseDataUtil.findData(GlobalConstants.CACHE_BASE, "queryBrandLists", params, brandListURL.toString());
    }
	...
	@Override
	public String queryGalleryList(String type, String frames,String brandId,String isSizePic) {
		Map<String, String> params = new HashMap<String, String>();
		params.put("type", type);
		params.put("frames", frames);
		params.put("issizepic", isSizePic);
		params.put("brandId", brandId);
		return BaseDataUtil.findData(GlobalConstants.CACHE_BASE, "AlterPic/gallery", params, galleryURL.toString());
	}
...
@Override
	...
	@Override
    public String findProductDetailNew(String activityId, String productId, String userId, String picNo, String version) {
        Map<String, String> params = new HashMap<String, String>();
        params.put("activityId", activityId);
        params.put("productId", productId);
        params.put("userId", userId);
	...
	@Override
    public String findProductDetailNew(String activityId, String productId, String userId, String picNo, String isNew, String version) {
        Map<String, String> params = new HashMap<String, String>();
        params.put("activityId", activityId);
        params.put("productId", productId);
        params.put("userId", userId);
	...
	@Override
	public String findModelInfo(String id, String type, String version,String userId) {
		Map<String, String> params = new HashMap<String, String>();
	...
	@Override
	//获取底部导航栏图标
	public String getBottomNavigatePic(String plateForm,String version) {
		Map<String, String> params = new HashMap<String, String>();
	 ...
	 */
	@Override
	public String findOrderMoreLogistic(String json) {
		Map<String, String> params = new HashMap<String, String>();
		params.put("jsonMsg", json);
		String result = HttpClientUtil.doGet(logisticUrl.toString(), params);
		return result;
	}
