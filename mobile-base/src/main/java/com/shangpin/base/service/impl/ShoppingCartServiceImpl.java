...
public class ShoppingCartServiceImpl implements ShoppingCartService {
	...
	private StringBuilder cartCountUrl = new StringBuilder(GlobalConstants.BASE_URL_TRADE).append("trade/cartGoodsCount");

	private String cartCountUrlV3 = new StringBuilder(GlobalConstants.BASE_URL_ORDER).append("ShopCart/CartGoodsCount").toString();

    private String modifyCartV3 = new StringBuilder(GlobalConstants.BASE_URL_ORDER).append("ShopCart/ModifyCart").toString();

    private String deleteCartV3 = new StringBuilder(GlobalConstants.BASE_URL_ORDER).append("ShopCart/DeleteCart").toString();

	private String showCartV3 = new StringBuilder(GlobalConstants.BASE_URL_ORDER).append("ShopCart/ShowCart").toString();

	private String addCartV3 = new StringBuilder(GlobalConstants.BASE_URL_ORDER).append("ShopCart/addproducttocart").toString();
...
/////////////////// 520 ////////////////
	...
	@Override
	public String cartCount(String userId, String checked) {
		Map<String, String> map = new HashMap<String, String>();
		map.put("userId", userId);
		map.put("isChecked", checked);
		return HttpClientUtil.doGet(cartCountUrl.toString(), map);
	}

	@Override
	public String cartCountV3(String json) {

		Map<String, String> map = new HashMap<String, String>();
		map.put("jsonMsg",json);
		return HttpClientUtil.doGet(cartCountUrlV3, map);
	}

    @Override
    public String modifyCartV3(String json) {
        Map<String, String> map = new HashMap<String, String>();
        map.put("jsonMsg",json);
        return HttpClientUtil.doGet(modifyCartV3, map);
    }

    @Override
    public String deleteCartV3(String json) {
        Map<String, String> map = new HashMap<String, String>();
        map.put("jsonMsg",json);
        return HttpClientUtil.doGet(deleteCartV3, map);
    }

	@Override
	public String showCartV3(String json) {
		Map<String, String> map = new HashMap<String, String>();
		map.put("jsonMsg",json);
		return HttpClientUtil.doGet(showCartV3, map);
	}

	@Override
	public String addCartV3(String json) {
		Map<String, String> map = new HashMap<String, String>();
		map.put("jsonMsg",json);
		return HttpClientUtil.doGet(addCartV3, map);
	}
}
