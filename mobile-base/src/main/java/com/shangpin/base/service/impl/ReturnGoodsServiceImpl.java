...
public class ReturnGoodsServiceImpl implements ReturnGoodsService {
	...
	private StringBuilder findListLogisticsDatailRUL=new StringBuilder(GlobalConstants.BASE_URL_ERP).append("BaseDataService.svc/GetDeliveryCompany");
...
//		params.put("orderNo", orderNo);
	...
	@Override
	public String findListLogisticsDatails() throws Exception{
		 HashMap<String, String> params = new HashMap<String, String>();
         params.put("SupplierNo", "Partner"); 
		 return HttpClientUtil.doPostWithJSON(findListLogisticsDatailRUL.toString(), JsonUtil.toJson(params));
	}
}
