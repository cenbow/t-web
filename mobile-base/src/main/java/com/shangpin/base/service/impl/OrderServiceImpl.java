...
public class OrderServiceImpl implements OrderService {
	...
	//确认收货V3
	private String finishOrderV3 = new StringBuilder(GlobalConstants.BASE_URL_ORDER).append("OrderCenter/FinishOrder").toString();

	//订单详情V3
	private String detailV3Url = new StringBuilder(GlobalConstants.BASE_URL_ORDER).append("OrderCenter/OrderDetail").toString();

	//订单列表V3
	private String listUrl = new StringBuilder(GlobalConstants.BASE_URL_ORDER).append("OrderCenter/OrderList").toString();

	// 礼品卡支付
	private String payGiftCardsURL = new StringBuffer(GlobalConstants.BASE_URL_ORDER).append("PayCenter/OrderGiftCardPay").toString();

	// 未支付订单订单信息
	private String orderPriceInfo = new StringBuffer(GlobalConstants.BASE_URL_ORDER).append("OrderCenter/GetOrderPriceInfo").toString();

	// 取消订单
	private String cancelOrderURL = GlobalConstants.BASE_URL_ORDER.concat("Order/OrderCancel");

	// 更改订单支付方式
	private String updatePayTypeURL = GlobalConstants.BASE_URL_ORDER.concat("PayCenter/UpdateOrderPayType");
	...
	public String cancelOrder(String json) {
		...
		Map<String, String> params = new HashMap<String, String>();
		params.put("jsonMsg",json);
		String result = HttpClientUtil.doPost(cancelOrderURL.toString(), params);
		return result;
	}
	...
	@Override
	public String updatePayType(String s) {
		Map<String, String> params = new HashMap<String, String>();
	...
	@Override
	public String finishOrderV3(String s) {

		Map<String,String> map = new HashMap<>();
		map.put("jsonMsg",s);
		return HttpClientUtil.doGet(finishOrderV3, map);
	}

	@Override
	public String detailV3(String s) {

		Map<String,String> map = new HashMap<>();
		map.put("jsonMsg",s);
		return HttpClientUtil.doGet(detailV3Url, map);
	}

	@Override
	public String payGiftCards(String json) {

		Map<String,String> map = new HashMap<>();
		map.put("jsonMsg",json);
		return HttpClientUtil.doGet(payGiftCardsURL, map);
	}
	...
	public String list(String s) {
		...
		Map<String,String> map = new HashMap<>();
		map.put("jsonMsg",s);
		return HttpClientUtil.doGet(listUrl, map);
	}

	@Override
	public String orderPriceInfo(String s) {

		Map<String,String> map = new HashMap<>();
		map.put("jsonMsg",s);
		return HttpClientUtil.doGet(orderPriceInfo, map);
	}
