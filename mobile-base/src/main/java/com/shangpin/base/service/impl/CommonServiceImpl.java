...
public class CommonServiceImpl implements CommonService {
    ...
    // 根据手机号查找用户接口
    private StringBuilder checkUserURL = new StringBuilder(GlobalConstants.BASE_URL_TRADE).append("listingcatalog/checkUser");//TODO 即将由用户服务提供，接口地址需要迁移
    // 支付日志写入接口
    ...
    // 登录后在个人中心修改密码或修改礼品卡支付密码
 	...
 	//发送短信验证码
 	private StringBuilder sendMsgVerfyCodeURL = new StringBuilder(GlobalConstants.BASE_URL_SHANGPIN_AOLAI).append("sendMsgVerfyCode");
...
//    }
	...
	public String sendMsgVerfyCode(String userId, String phoneNum, String type) {
		...
		params.put("type", type);
		return HttpClientUtil.doGet(sendMsgVerfyCodeURL.toString(), params);
	}
