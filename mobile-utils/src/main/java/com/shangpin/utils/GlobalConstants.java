...
public class GlobalConstants {
    ...
    // http连接超时时间。默认值设置为30秒
    public static final int CONNECT_TIMEOUT_INNER = PropertyUtil.getIntValue("httpclient.connect_timeout_inner", 1000000);
    // socket连接超时时间。默认值设置为15秒
    public static final int SOCKET_TIMEOUT_INNER = PropertyUtil.getIntValue("httpclient.socket_timeout_inner", 105000);
