...
public class StringUtil {
    ...
    /**
   	 * 格式字符串，替换输出,如果没有可替换的原样返回
   	 * @param format 需要替换格式化的字符串，{}包围需要替换的字符串 如：<br/>
   	 * {gateway},{},{bbb}其中包围的字符串可有可无
   	 * @param objs 顺序替换的字符，长度可以与要替换的{}个数不一致<br/>
   	 * 多于{}个数则只替换需要的，少于则不原样输出{}
   	 * @return
   	 */
   	public static String format(String format,String... objs){
   		if(objs==null) return format;
