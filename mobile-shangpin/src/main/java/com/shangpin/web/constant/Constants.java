package com.shangpin.web.constant;

import com.shangpin.base.utils.GlobalConstants;
import com.shangpin.web.utils.PropertyUtil;
import com.shangpin.web.utils.RunPropertyUtil;
import com.shangpin.web.utils.WeixinPropertyUtil;
...
public class Constants {
    ...
    public static final String SESSION_USER_LEVEL = "mshangpin_user_level";
	...
	public static final String SP_PAY = "6";
    ...
    public static final String SHANGPIN_URL = GlobalConstants.BASE_URL_SHANGPIN_M;//PropertyUtil.getString("shangpin_url");
    ...
    public static final String VIP_WX_PUB_CODE = "wx_pub_code";//微信pub的code码，可以兑换token
	...
	public static final String CMBC_PAY = "7";
    ...
    public static final String  MOBILE_VERSION =GlobalConstants.MOBILE_VERSION;//m站版本
    public static final String  MOBILE_PLAT = GlobalConstants.MOBILE_PLAT; //m站Type 1：pc  2:m  3:app

    /**未绑定手机号的用户m站登录时用户及回调暂存session的key*/
    public static final String THRIDLOGIN_SESSION_TYPE = "mshangpin_thridLogin_session_type";
    public static final String THRIDLOGIN_SESSION_USER = "mshangpin_thridLogin_session_user";
    public static final String THRIDLOGIN_SESSION_BACK = "mshangpin_thridLogin_session_backUrl";
	...
	public static final String[] THRID_COOKIE_LEVELS ={
														...
														"{\"source\":\"iqiyi\",\"expires\":\"30\", \"level\": \"100\"}",//爱奇艺
														"{\"source\":\"lktwap\",\"expires\":\"30\", \"level\": \"100\"}",//领克特wap
														"{\"source\":\"yqfwap\",\"expires\":\"30\", \"level\": \"100\"}",
														"{\"source\":\"baidusemwap\",\"expires\":\"30\", \"level\": \"100\"}",
														"{\"source\":\"gdtwap\",\"expires\":\"30\", \"level\": \"100\"}",
														"{\"source\":\"zhtwap\",\"expires\":\"30\", \"level\": \"100\"}",
														"{\"source\":\"toutiaowap\",\"expires\":\"30\", \"level\": \"100\"}",
														"{\"source\":\"mls\",\"expires\":\"15\", \"level\": \"100\"}",
														"{\"source\":\"mlswap\",\"expires\":\"15\", \"level\": \"100\"}",
														"{\"source\":\"ybwap\",\"expires\":\"30\", \"level\": \"100\"}",
														"{\"source\":\"smzdm\",\"expires\":\"15\", \"level\": \"100\"}",
														"{\"source\":\"smzdmwap\",\"expires\":\"15\", \"level\": \"100\"}",
														"{\"source\":\"hsm\",\"expires\":\"15\", \"level\": \"100\"}",
														"{\"source\":\"hsmwap\",\"expires\":\"15\", \"level\": \"100\"}",
														"{\"source\":\"spwbwap\",\"expires\":\"365\", \"level\": \"100\"}",//官方微博wap
														"{\"source\":\"spwxwap\",\"expires\":\"365\", \"level\": \"100\"}",//官方微信wap
                                                        "{\"source\":\"kol\",\"expires\":\"30\", \"level\": \"100\"}",//博主PC
                                                        "{\"source\":\"kolwap\",\"expires\":\"30\", \"level\": \"100\"}",//博主wap
                                                        "{\"source\":\"hfive\",\"expires\":\"30\", \"level\": \"100\"}",//H5推广PC
                                                        "{\"source\":\"hfivewap\",\"expires\":\"30\", \"level\": \"100\"}",//H5推广wap
                                                        "{\"source\":\"fst\",\"expires\":\"30\", \"level\": \"100\"}",//粉丝通
                                                        "{\"source\":\"fstwap\",\"expires\":\"30\", \"level\": \"100\"}",//粉丝通wap
                                                        "{\"source\":\"grazia\",\"expires\":\"30\", \"level\": \"100\"}",//红秀
                                                        "{\"source\":\"graziawap\",\"expires\":\"30\", \"level\": \"100\"}",//红秀wap
                                                        "{\"source\":\"cosmo\",\"expires\":\"30\", \"level\": \"100\"}",//尚COSMO
                                                        "{\"source\":\"cosmowap\",\"expires\":\"30\", \"level\": \"100\"}",//尚COSMO wap
                                                        "{\"source\":\"vogue\",\"expires\":\"30\", \"level\": \"100\"}",//VOGUE
                                                        "{\"source\":\"voguewap\",\"expires\":\"30\", \"level\": \"100\"}",//VOGUE wap
                                                        "{\"source\":\"shyyj\",\"expires\":\"30\", \"level\": \"100\"}",//上海音乐节
                                                        "{\"source\":\"souhuhswap\",\"expires\":\"21\", \"level\": \"100\"}",//搜狐wap
                                                        "{\"source\":\"starwap\",\"expires\":\"30\", \"level\": \"100\"}",//明星
														};
