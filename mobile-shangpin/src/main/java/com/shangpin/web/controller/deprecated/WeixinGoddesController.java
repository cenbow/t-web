package com.shangpin.web.controller.deprecated;
...
import com.shangpin.web.controller.weixin.WeixinControllerParent;
...
public class WeixinGoddesController extends WeixinControllerParent{
    ...
    private boolean isRegister(String phoneNum){
    	...
    	return Constants.IS_NEW_USER.equals(quickUser.getIsNewUser()) ;
    }
    ...
    private User weixinAutoLogin(AccountWeixinBind account){
    	return userService.weixinAutoLogin(account);
    }
    ...
    private Map<String, Object> activeObj(String userId, String activeCode,String couponType){
    	...
    	return bizCouponService.sendCoupon(userId, "1", "coupon:" + activeCode, couponType);
    }
}
