...
import com.shangpin.web.controller.product.ProductController;
...
public class ActivityController extends BaseController{
    ...
    public  Map<String, Object> followRemind(@RequestParam String phoneNum,String verifyCode,@RequestParam String code,@RequestParam String time,
        ...
        return spBizActivityService.activityStartRemind(phoneNum, code, time);
    }
	...
	public String getCoupon(HttpServletRequest request,String topicId,Model model) {
		User user = getSessionUser(request);
		Map<String, Object> map = bizCouponService.sendCoupon(user.getUserId(), "1", "coupon:2644709794", "30");
