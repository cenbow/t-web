...
public class ThirdBuyInterceptor extends HandlerInterceptorAdapter {
	public static final Logger logger = LoggerFactory.getLogger(ThirdBuyInterceptor.class);
	@Override
	...
	private void setShangPinKe(HttpServletRequest request){
		...
		if(StringUtils.isNotBlank(channelId)){
			logger.debug("ThirdBuyInterceptor===========>======>spuNo:"+spuNo+"  topicId:"+topicId+"   channelNo:"+channelNo+"  channelId:"+channelId);
			boolean flag = false;
