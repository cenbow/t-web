;$(function(){
	...
	var up,animaed,regionCode;

	var selectYes = $("#selectYes");
	var selectClose = $("#selectClose");
	var data = eval($("#logisticsInfo").val());
	...
	$(".payment-btn").click(function(e){
		...
		if ($.trim($("#tNumber").val()) == ""){
        	...
        	!1;
		}else if($("#tNumber").val().indexOf(" ") != -1 || !tN.test($.trim($("#tNumber").val()))){
