		...
		$.ajax({
            ...
            success: function(data){
            	...
            	var msg2 = user.faceValue;
            	 if(_isapp){
            	 	var hosturl = "http://"+window.location.hostname+getRootPath();
            		//如果是app
            		window.location.href="shangpinapp://phone.shangpin/actiongoshare?title=您的小伙伴"+user.buyerName+"给您送祝福来了！&desc="+user.wishMsg+"&url="+hosturl+"/giftCard/skipToVerifyCode?"+msg;
            	 }else if(_iswx){
         			//微信分享js
