	    ...
	    <c:choose>  
            ...
            <div class="add_list">
		        ...
		        <p class="clr">
		          ...
		          <span class="right">${orderLogistics.receive.provName}${orderLogistics.receive.cityName}${orderLogistics.receive.areaName}${orderLogistics.receive.townName}${orderLogistics.receive.addr}</span>
		        </p>
		        <p class="clr">
