<%@ page language="java" contentType="text/html; charset=UTF-8" trimDirectiveWhitespaces="true"
    pageEncoding="UTF-8"%>
<div id="settle_coupon" style="display: none">
	<c:choose>
		<c:when test="${!checkAPP}">
			<div class="topFix" id="coupons_head" >
			   <section>
			       <div class="topBack" >
			...
			<div class="alContent order_coupons" id="coupons_content" type="" style="min-height: 550px;">
		</c:when>
		<c:otherwise>
			<div class="alContent order_coupons" id="coupons_content" type=""  style="margin-top: 0;min-height: 100%;">
		</c:otherwise>
	</c:choose>
