<%@ page language="java" contentType="text/html; charset=UTF-8" trimDirectiveWhitespaces="true"
    pageEncoding="UTF-8"%>
<div id="settle_address_add" style="display: none;">
	<c:choose>
		<c:when test="${!checkAPP}">
			<div class="topFix" id="address_add_head" >
			   <section>
			       <div class="topBack" >
			...
			<div class="order_address_add alContent" id="address_add_content" style="min-height:550px;">
		</c:when>
		<c:otherwise>
			<div class="order_address_add alContent" id="address_add_content" style="margin-top: 0;">
		</c:otherwise>
	</c:choose>
