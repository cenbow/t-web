<%@ page language="java" contentType="text/html; charset=UTF-8" trimDirectiveWhitespaces="true"
         pageEncoding="UTF-8"%>
<div id="settle_invoice" style="display: none">
<c:choose>
    <c:when test="${!checkAPP}">
        <div class="topFix" id="invoice_head" >
            <section>
                <div class="topBack" >
        ...
        <div class="alContent" id="invoice_content" style="min-height: 550px;" >
    </c:when>
    <c:otherwise>
        <div class="alContent" id="invoice_content" style="margin-top: 0;min-height: 100%;" >
    </c:otherwise>
</c:choose>
<!--头部 start-->
    <div class="invoice_block">
            <fieldset class="notBtm">
                <legend>发票信息</legend>
                <c:set var="invoice" value="${settle.invoice}"></c:set>
                <c:set var="temp" value="${not empty settle.invoice.lastInvoice}"></c:set>
