 ...
 <div class="detailed_information">
 	<div class="product_show">
        ...
        <section>
          <header>
                <span>
                    ${productDetail.basic.brand.nameEN }
                </span>
          ...
          <div>
           ...
           <c:set var="color" value="${productDetail.basic.firstProps[firstP].secondProps[secondP].priceTag[0].color eq ''? '#000' : productDetail.basic.firstProps[firstP].secondProps[secondP].priceTag[0].color}"/>
            ...
            <c:if test="${productDetail.basic.firstProps[firstP].secondProps[secondP].priceTag[1].isShow ==1}">
			  <c:set var="colorTy" value="${productDetail.basic.firstProps[firstP].secondProps[secondP].priceTag[1].color eq ''? '#000' : productDetail.basic.firstProps[firstP].secondProps[secondP].priceTag[1].color}"/>
			  <div style="color: ${colorTy}" class="font_gray">
              <ol>
                <li>${productDetail.basic.firstProps[firstP].secondProps[secondP].priceTag[1].priceTitle}<%-- ${productDetail.basic.firstProps[firstP].secondProps[secondP].shopPrice }--%>&nbsp;&nbsp;${productDetail.basic.firstProps[firstP].secondProps[secondP].priceTag[1].priceDesc}
                </li>
              </ol>
             </div>
			 </c:if>
