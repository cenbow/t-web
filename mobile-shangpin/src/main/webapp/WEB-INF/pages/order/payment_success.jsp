		...
		<div class="paymet_block">
		        <div class="paymet_success">
					...
					<div class="payment_submit clr">
					    <a href="${ctx }/order/list" class="payment_btn">查看订单</a>
		            ...
		            <div class="coupon_tip">
		            	...
		            	<c:set var="totalPrice" value="${totalPrice*1 }" />
		            	<c:choose>
		         ...
		         <%--<c:import url="/coupon/product/list?from=pay&payAmount=${totalPrice}"></c:import>--%>
	            </div>
		        </div>
	</div>
