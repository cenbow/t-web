...
.payment_block_o .submit_btn{ color:#fff; font-size:18px; line-height:40px; height:40px; margin:10px 10px 30px; display:block; background:#0700c5; text-align:center;}
</style>
...
<div class="container">
    <div class="payment_block_o">
        ...
        <a href="${pageContext.request.contextPath}/login?back=/user/home"  class="submit_btn" id="payment_c_btn" ctag='{"id":"H1"}'>登录</a>
    </div>
</div>
</rapid:override>
