...
<rapid:override name="custum">
	...
	<script language="javascript" type="text/javascript">
		...
		NTKF_PARAM = {
			...
			uid:"${sessionScope.mshangpin_user.userId}",         //用户ID，未登录可以为空，但不能给null，uid赋予的值在显示到小能客户端上
			uname:"${sessionScope.mshangpin_user.name}",         //用户名，未登录可以为空，但不能给null，uname赋予的值显示到小能客户端上
			isvip:"${sessionScope.mshangpin_user.lv=='0006' ? '1' : '0'}",                          //是否为vip用户，0代表非会员，1代表会员，取值显示到小能客户端上
