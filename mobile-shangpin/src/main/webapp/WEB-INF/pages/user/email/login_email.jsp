...
<rapid:override name="content">
    <form name="login" id="J_mailForm" method="post" action="${ctx}/login/checkCode/email">
        <fieldset>
            <p class="c-form-search">
                <label for="mobi" class="mail"></label>
                <input type="text" id="J_mailName" name="mobi" placeholder="请输入邮箱" value = "${mobi}"  />
            ...
            <a href="${ctx}/login" class="login_mail" ctag='{"id":"H1"}'>使用手机登录</a>
        </fieldset>
    </form>
