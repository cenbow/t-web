...
<rapid:override name="custum">
    ...
    <link href="${cdn:css(pageContext.request)}/styles/shangpin/css/page/user/others_bindtel1.css${ver}" rel="stylesheet" />
    ...
    <div class="tabs_box">
        <div class="tabs_Cell">
            <form name="login" id="J_bindForm" method="post" action="${ctx}/thirdLogin/bindPhone">
                <input type="hidden" name="bindteltype" value="1">
                <fieldset>
                    <p class="c-form-search">
                        <label for="mobi" class="mobi"></label>
                        <input type="text" id="J_MobiName" name="mobi" placeholder="请输入手机号" required onkeyup='this.value=this.value.replace(/\D/gi,"")' maxlength="11" value="${mobi}" />
                    ...
                    <a class="pwd_tips" href="javascript:;">绑定后，您的${third_type}账号和手机号都可以登录</a>
