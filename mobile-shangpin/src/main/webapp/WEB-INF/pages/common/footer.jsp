	...
	<c:when test="${checkWX }">
		<footer class="wx_foot">
			...
			<div class="wxCopyright">
				...
				2010-2016 Shangpin.com All Rights Reserved
			</div>
		</footer>
		...
		<div class="app_bg">
			<footer class="app_foot">
				...
				<c:choose>
					<c:when test="${sessionScope.mshangpin_user == null }">
						<p class="app_user">
							...
							<a href="${ctx}/login" ctag='{"id":"H1"}'>登录</a> <%--&nbsp;&nbsp;|&nbsp;&nbsp;<a
								href="${ctx}/toRegister">注册</a>--%>						</p>
					</c:when>
					<c:otherwise>
						<p class="app_user">
				...
				<div class="appCopyright">
					...
					Copyright 2010-2016 Shangpin.com 版权所有<br /> 北京尚品百姿电子商务有限公司
				</div>
