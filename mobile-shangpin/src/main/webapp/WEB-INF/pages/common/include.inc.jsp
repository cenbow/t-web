...
<c:set var="ver" value="?20161008202510001"/>
...
<c:if test="${fn:containsIgnoreCase(ua, shangpinIOSApp)}">
	<c:set var="_isClientIOS" value="true" />
</c:if>
<c:if test="${fn:containsIgnoreCase(ua, shangpinAndroidApp)}">
	<c:set var="_isClientAndroid" value="true" />
</c:if>
...
<c:set var="_isVip" value="${sessionScope.mshangpin_user.isVip() }"/>