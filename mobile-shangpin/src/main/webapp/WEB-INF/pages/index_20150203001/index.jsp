...
<rapid:override name="custum">
	...
	<link href="${cdn:css(pageContext.request)}/styles/shangpin/css/page/home150918.css${ver}" rel="stylesheet" />
...
<rapid:override name="content">
	...
	<c:import url="/index/advert"></c:import> 
 	<%--<c:import url="/index/fashion"></c:import> 潮流趋势--%>
 	<%--分类 --%>
  	 <%--<c:import url="/index/addCategory"></c:import>分类 --%>
