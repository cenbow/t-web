...
public class Order implements Serializable{
	...
	private static class Share{
		...
		private String isShare;//"分享按钮 0否1是",
		private String shareName;//":"按钮上的文本", 
		private String shareTitle;//"topShop",
		private String shareUrl;// : "www.baidu.com",
		private String shareDesc;//":"分享内容",
		private String shareImgUrl;//":"",
		private String isMorethan;//":"是否多于1件，0否:本地分享,1是多件，跳wap页面",
		private String wapurl;//:"www.baidu.com",
		private String wapTitle;//":"title"
