...
public abstract class AbstractBizCommonService {
	 ...
	 * @param type
	 * @param frames
	 * @param isSizePic 为空或者0 小图，1为大图
	 * @return
	 */
	public GalleryList queryGallery(String type, String frames,String isSizePic) {
		GalleryList gallery = null;
		try {
			String json = shangPinService.queryGalleryList(type, frames,null,isSizePic);
...
//		}
	...
	/** 首页模版 */
	public ModelTitle doBaseModelTitle(String version,String userId) throws Exception {
		String baseData = shangPinService.findModelInfo("", "1", version,userId);
