...
public abstract class AbstractBizOrderService {
	...
	public ResultObjOneResult<OrderItem> beOrderDetail(String userId, String orderId) {
		...
		if (!StringUtils.isEmpty(json)) {
			ResultObjOneResult<OrderItem> result = JsonUtil.fromJson(json, new TypeToken<ResultObjOneResult<OrderItem>>() {});
			return result;
		}
		return null;
	}
	...
	public String fromCancelOrder(String userId, String orderId) {
		...
		String json = orderService.cancelOrder(obj.toString());
		return json;
	}
