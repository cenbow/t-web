...
public abstract class AbstractBizReturnGoodsService {
    ...
    public String logisticsSubmit(String userId, String applyNo, String logisticsNo, String logisticsCompany,String companyCode){
    	String json = returnGoodsService.logisticsSubmit(userId, applyNo, logisticsNo, logisticsCompany,companyCode);
    	return json;
    }
    
    public ResultBase logisticsSubmitObj(String userId, String applyNo, String logisticsNo, String logisticsCompany,String companyCode){
    	String json = this.logisticsSubmit(userId, applyNo, logisticsNo, logisticsCompany,companyCode);
    	if(StringUtils.isEmpty(json)){
    		return null;
    	}
    ...
    public String findListLogisticsDatails(){
    	
    	String json=null;
		try {
			json = returnGoodsService.findListLogisticsDatails();
		} catch (Exception e) {
		}
    	return json;
    }
