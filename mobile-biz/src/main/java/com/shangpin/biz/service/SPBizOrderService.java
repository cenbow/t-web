...
public interface SPBizOrderService extends IBizOrderService {
	 ...
	 * @author zhongchao
	 */
	public OrderListResult orderlist(List<String> userId, String status);
	 ...
	 * @Create Date 2016
	 */
	 ResultObjOne<GiftCardReturn> payGiftCards(String userId, String password,String orderId);
	 ...
	 * @return
	 */
	ResultBase updatePayType(String userId, String orderId, String mainPayId,String subPayId,String bankId);

	OrderListResult orderlist(String userId, String status, String pageIndex);

	Map<String, Object> cancelOrder(String userid, String mainOrderNo,
			String postArea);
	 ...
	 * @return
	 */
	 Map<String,Object> finishedOrderV3(String userId, String mainOrderNo);
     ...
     * @return
     */
    ResultObjOne<OrderDetailResult> findOrderDetailV3(List<String> userId, String mainOrderId, String orderId, String isSplitOrder);
     ...
     * @return
     */
	ResultObjOne<OrderPriceInfo> findOrderPriceInfo(String userId,String orderId);

	/**
	 * 获取各种订单的数量
	 * @param userId
     */
	UserBuyInfo getOrderCount(String userId);
}
