...
public abstract class AbstractBizProductService {
	 ...
	 * @date 2015年3月13日
	 */
	public ProductDetail fromFindProductDetail(String activityId, String productId, String userId,String picNo,String version) {
		try {
			String json = shangPinService.findProductDetailNew(activityId, productId, userId,picNo,version);;
